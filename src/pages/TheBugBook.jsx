  ...
  return (
    <>
      ...
      <StyledSubHeading $space>
        ...
        features that are crucial. After that to create a main page where users
        access everything that they need. Then to create a profile page where
        the user can manage his following, followers and edit his profile.
        Afterwards, to create a functional messaging system where users can
        chat. And when all of that is done to create a notification system that
        will trigger on likes, comments and follows while messages have their
        own notifications.
      </StyledSubHeading>
      <StyledProjectBox>
        <StyledStack>
        ...
        <div>
          ...
          <StyledSubHeading $big>
            ...
            for social media application. Prisma was chosen because I wanted to
            use a postgres database from vercel and how easy is to connect to
            it.
          </StyledSubHeading>

          <StyledSubHeading $big $space>
            For the whole auth logic I used lucide and for creating users
            prisma. For validation of inputs I used Zod. For data mutation and
            fetching, I chose ReactQuery and ky. For uploading images I used
            uploadthing, and for editing images I chose react cropper and reacts
            image file resizer. For styling the application I used TailWindCSS
            with radix-ui and tip tap. Radix ui provides some quality components
            that are easy to use and tiptap provides good editor for creating a
            post. For the whole messaging logic i was using stream chat who
            provides hosted chat component that is so customizable and saves a
            lot of time implementing it . And for linkifying # links and profile
            I used to react linkify it. Vercel is also an obvious choice for
            deployment because of its speed and reliability for NextJS projects.
          </StyledSubHeading>
        </div>
      </StyledProjectBox>
      ...
      <StyledProjectBox>
        ...
        <div>
          ...
          <StyledSubHeading $big>
            ...
            ReactQuery, were a lot a difficult area, but I managed to make it
            work smoothly.
          </StyledSubHeading>
          ...
          <StyledSubHeading $big $space>
            ...
            using it. As well for the application the be the fastest as possible
            I was making components as reusable as possible and with help of a
            tailwind with redix-ui I managed to do that.
          </StyledSubHeading>
        </div>
      </StyledProjectBox>
      ...
      <StyledSubHeading>
        ...
        logic and so much more. As the largest project I have ever worked on, I
        learned a lot of new technologies and how to implement them in a real
        project. And with this project i think i have a good understanding of a
